 ...
 * An item running on a schema tree with Boolean functions will basically have many boolean values propogating upwards,
 * until reaching the root node. Which ever value that reaches the node is essentially the result value for shouldItemPass.
 * Here's a mental image of how a tree might look like:
 *
 *                      root
 *                   ___________
 *                  |           |
